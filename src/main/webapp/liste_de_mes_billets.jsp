...
<body>
<div class="card p-4">
    <h1 class="text-center mb-4">Historique des Billets</h1>
        ...
        <table class="table table-hover">
            ...
            <c:forEach var="b" items="${billets}">
                <tr>
                    ...
                    <td>
                        <a href="billets?action=annuler&id=${b.id}" class="btn btn-danger btn-sm">Annuler</a>
                        <a href="telecharger-ticket-pdf?id=${b.id}" class="btn btn-primary btn-sm">Télécharger PDF</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
